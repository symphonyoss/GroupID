...
import com.symphony.bots.ai.model.ArgumentType;
...
public class AiCommandInterpreterImpl implements AiCommandInterpreter {
  @Override
  public boolean isCommand(AiCommand aiCommand, AiMessage command) {
    String[] potentialCommand = command.getAiMessage().split(" ");

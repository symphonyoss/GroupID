...
public class HelpDeskAi extends SymphonyAi {
  ...
  public HelpDeskAi(HelpDeskAiSession helpDeskAiSession) {
    super(helpDeskAiSession.getSymphonyClient().getMessagesClient(),
        helpDeskAiSession.getHelpDeskAiConfig().isSuggestCommands(),
        helpDeskAiSession.getHelpDeskAiConfig().getSessionContextDir());
    aiSessionContextManager = new HelpDeskSessionContextManager(helpDeskAiSession);
  }

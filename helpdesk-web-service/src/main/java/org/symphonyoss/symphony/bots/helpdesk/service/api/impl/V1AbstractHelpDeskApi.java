package org.symphonyoss.symphony.bots.helpdesk.service.api.impl;

import org.symphonyoss.symphony.bots.helpdesk.service.api.V1ApiService;
...
public abstract class V1AbstractHelpDeskApi implements V1ApiService {
  ...
  protected abstract TicketSearchResponse searchTicket(String id, String groupId, String serviceRoomId, String clientStreamId);
  ...
  @Override
  public Response v1TicketSearchGet(String id, String groupId, String serviceRoomId, String clientStreamId) {
    return Response.ok(searchTicket(id, groupId, serviceRoomId, clientStreamId)).build();
  }

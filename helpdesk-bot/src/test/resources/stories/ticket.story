...
Given a service account agent1 with roles INDIVIDUAL
And a certificate for agent1 user
When agent1 user authenticates using a certificate
...
Given a service account agent2 with roles INDIVIDUAL
And a certificate for agent2 user
When agent2 user authenticates using a certificate

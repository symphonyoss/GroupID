...
public class ProxyConversation extends AiConversation {
  ...
  public void onMessage(AiResponder responder, AiMessage message) {
    ...
    if(makerCheckerService.allChecksPass(symphonyAiMessage)) {
      ...
      ProxyAiMessage proxyAiMessage = new ProxyAiMessage(symphonyAiMessage, proxyToIds);
      SymphonyAiMessage validationMessage = makerCheckerService.getMakerCheckerMessage(proxyAiMessage);

...
public class MembershipClient {
  ...
  public MembershipClient(String groupId, String memberServiceUrl) {
    ...
    this.membershipApi = new MembershipApi(apiClient);
  ...
  public Membership getMembership(String userId) {
    try {
      return membershipApi.getMembership(groupId, userId).getMembership();
  ...
  public Membership newMembership(String userId) {
    ...
    try {
      Membership newMembership = membershipApi.createMembership(groupId, membership).getMembership();
  ...
  public Membership updateMembership(Membership membership) {
    try {
      Membership updateMembership =
          membershipApi.updateMembership(groupId, membership.getId(), membership).getMembership();
